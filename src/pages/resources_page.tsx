            ...
            <div className="flex flex-col bg-slate-50 ">
                {props.items.map((d) => (                       
                    <div className="mx-8 mt-2 mb-2">                      
                        <div className="text-2xl"><a className="text-blue-400 hover:text-red-900" href={d.link}>{d.name}</a> - {d.desc}</div>                        
                    </div>
                ))}
            </div>
        </div>
...
function ResourcesPage() {
    return (
        <div className="mt-16 flex flex-col items-center ">
            ...
            <div className="mx-8 mt-2 grid grid-cols-1 gap-4 mb-8">
                {Resources.map((e, i) => (
